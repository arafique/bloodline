    ...
    Ember.Facebook = Ember.Mixin.create({
      ...
      fbAsyncInit: function() {
        ...
        FB.Event.subscribe('auth.authResponseChange', function(response) {
          console.log('Facebook response received. Calling updateFBUser');
      ...
      updateFBUser: function(response) {
        ...
        if (response.status === 'connected') {
          // console.log(this);
          // console.log(_this.get('LoginController'));
          // console.log(_this.get('Router'));
          // var loginController = this.get('LoginController');
          // console.log(loginController.toString());
